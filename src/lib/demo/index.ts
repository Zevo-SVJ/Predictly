...
export const DEMO_QUESTIONS: { question: string; brand?: BrandKey }[] = [
  ...
  { question: "Which nation will win the next World Cup?" },
  { question: "Will Starship carry a crew before 2028?" },
  { question: "Who will win the Ballon d'Or?" },
  { question: "Will Netflix win Best Picture at the next Oscars?" },
];
